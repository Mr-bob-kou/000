        ...
        if "Region" in st.session_state.modes:
            ...
            if"Inscription Date" in st.session_state.modes:
                ...
                with col7:
                    ...
                    charts1 = alt.Chart(years).mark_line(point=True).encode(x=alt.X("DATEINSCRI",type='temporal'),y=alt.Y(alt.repeat("layer"),type='quantitative',title='count'), color=alt.datum(alt.repeat("layer"))).repeat(layer=["C", "C/N","N"])
