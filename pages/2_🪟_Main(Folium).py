        ...
        if "Region" in st.session_state.modes:
            ...
            if"Inscription Date" in st.session_state.modes:
                ...
                with col7:
                    ...
                    cond2=alt.condition(alt.datum.DATEINSCRI==Inscdate,alt.value('red'),alt.Color(alt.datum(alt.repeat("layer")),scale=alt.Scale(domain=['C', 'C/N', 'N'], range=['blue', 'orange', 'green'])))
